<template>
  <div class="playMusic">
    ...
    <div class="playContent" v-if="!isLyric" v-on:dblclick="isLyric = !isLyric">
    ...
    <div class="playLyric" v-else refs="playLyric" v-on:dblclick="isLyric = !isLyric">
  ...
  methods: {
    goPlay(num) {
      ...
      else if(index == this.playlist.length)
      {
        ...
        //console.log(this.playCurrentIndex.length-1);
      }
...
.playLyric::-webkit-scrollbar {display:none}
.active {
  color: red;
}
</style>
